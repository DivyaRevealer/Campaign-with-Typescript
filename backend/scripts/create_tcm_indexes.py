...
async def create_indexes():
    ...
    indexes = [
        ...
        ("idx_crm_tcm_store_state", "CREATE INDEX idx_crm_tcm_store_state ON crm_analysis_tcm(LAST_IN_STORE_STATE)"),
        ("idx_crm_tcm_store_city", "CREATE INDEX idx_crm_tcm_store_city ON crm_analysis_tcm(LAST_IN_STORE_CITY)"),
        ("idx_crm_tcm_store_name", "CREATE INDEX idx_crm_tcm_store_name ON crm_analysis_tcm(LAST_IN_STORE_NAME)"),
        ("idx_crm_tcm_store_location", "CREATE INDEX idx_crm_tcm_store_location ON crm_analysis_tcm(LAST_IN_STORE_STATE, LAST_IN_STORE_CITY, LAST_IN_STORE_NAME)"),
