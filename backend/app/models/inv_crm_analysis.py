"""CRM Analysis model for RFM analysis and customer segmentation."""
...
class InvCrmAnalysis(Base):
    """CRM Analysis table containing RFM scores and customer segmentation data."""
